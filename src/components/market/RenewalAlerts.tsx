        ...
        <div className="flex items-center gap-2 mb-4">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-8 pr-3 py-1.5 text-xs border border-slate-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-amber-300"
            />
          </div>
          <button
            type="button"
            onClick={() => setSortBy((prev) => (prev === 'date' ? 'amount' : 'date'))}
            className="flex items-center gap-1 px-2.5 py-1.5 text-xs text-slate-600 bg-slate-50 rounded-lg hover:bg-slate-100 transition-colors"
          >
